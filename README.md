...
* **[MCP Plexus](https://github.com/super-i-tech/mcp_plexus)** A secure, **multi-tenant** AI backend framework enhancing FastMCP with robust isolation, OAuth integration with built-in flow management, and persistent user-specific access.
